      ...
      <header className="border-b border-white/10 px-5 py-4 lg:hidden">
        <div className="flex items-center justify-between">
          <Link href="/" className="font-semibold">
            Prompt<span className="text-cyan-400">Market</span>
          </Link>
          <button
            type="button"
          ...
          >
            {menuOpen ? "Close workspace" : "Open workspace"}
          </button>
        </div>
          ...
          <nav className="mt-4 space-y-2 border-t border-white/10 pt-4">
            {navigation.map((item) => (
              <Link
                ...
                className="block rounded-xl bg-white/5 px-4 py-3 text-sm"
              >
                {item.label}
              </Link>
            ))}
        ...
        <aside className="hidden w-72 shrink-0 border-r border-white/10 bg-slate-900/40 p-6 lg:flex lg:flex-col">
          ...
          <div className="mt-8 rounded-2xl border border-cyan-400/15 bg-cyan-400/5 p-4">
            ...
            <div className="mt-3 flex gap-2">
              <span className="rounded-full bg-cyan-400/10 px-3 py-1 text-xs uppercase text-cyan-300">
                {marketplaceUser?.role}
              </span>
              <span className="rounded-full bg-violet-400/10 px-3 py-1 text-xs uppercase text-violet-300">
                {marketplaceUser?.subscription || "free"}
              </span>
            </div>
          </div>
          ...
          <button
            ...
            className="mt-auto rounded-xl border border-white/10 px-4 py-3 text-left text-sm text-slate-300"
          >
